...
type WebBuildManifest struct {
	...
	Assets struct {
		Main      *entryAssets `json:"src/enterprise/main.tsx"`
		EmbedMain *entryAssets `json:"src/enterprise/embed/embedMain.tsx"`
		AppMain   *entryAssets `json:"src/enterprise/app/main.tsx"`
	} `json:"assets"`
